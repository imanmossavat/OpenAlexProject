...
from app.services.staging.identifier_utils import (
    extract_doi_from_url,
    normalize_doi,
    normalize_openalex_id,
)
from app.services.staging.matchers import IMetadataMatcherFactory
...
class StagingMatchService:
    ...
    def __init__(
        ...
        matcher_factory: IMetadataMatcherFactory,
    ...
    async def match_rows(
        ...
        *,
        ...
        if rows_needing_metadata:
            matcher = self._matcher_factory.create(api_provider)
